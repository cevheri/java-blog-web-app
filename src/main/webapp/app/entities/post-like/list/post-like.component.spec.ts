...
describe('PostLike Management Component', () => {
  let comp: PostLikeComponent;
  let fixture: ComponentFixture<PostLikeComponent>;
  let service: PostLikeService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'post-like', component: PostLikeComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PostLikeComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.postLikes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
