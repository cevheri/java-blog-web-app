...
describe('PostComment Management Component', () => {
  let comp: PostCommentComponent;
  let fixture: ComponentFixture<PostCommentComponent>;
  let service: PostCommentService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'post-comment', component: PostCommentComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.postComments?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
