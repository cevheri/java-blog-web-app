...
describe('ThirdPartyApp Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'third-party-app', component: ThirdPartyAppComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(ThirdPartyAppComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.thirdPartyApps?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
