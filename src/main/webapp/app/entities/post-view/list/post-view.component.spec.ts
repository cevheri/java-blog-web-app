...
describe('PostView Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'post-view', component: PostViewComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(PostViewComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.postViews?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
