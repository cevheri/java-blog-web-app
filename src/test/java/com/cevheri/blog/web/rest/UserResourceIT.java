...
import com.cevheri.blog.domain.Authority;
...
import com.cevheri.blog.service.dto.AdminUserDTO;
import com.cevheri.blog.service.dto.UserDTO;
import com.cevheri.blog.service.mapper.UserMapper;
import com.cevheri.blog.web.rest.vm.ManagedUserVM;
...
class UserResourceIT {
    ...
    private static final String UPDATED_LOGIN = "blogger";
    ...
    void updateUserExistingLogin() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setId(updatedUser.getId());
        managedUserVM.setLogin("blogger"); // this login should already be used by anotherUser
        managedUserVM.setPassword(updatedUser.getPassword());
        managedUserVM.setFirstName(updatedUser.getFirstName());
        managedUserVM.setLastName(updatedUser.getLastName());
