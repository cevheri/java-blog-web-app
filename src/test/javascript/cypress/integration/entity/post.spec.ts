...
describe('Post e2e test', () => {
  ...
  const postSample = { title: 'protocol Washington', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=' };
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      ...
      cy.get(`[data-cy="paidMemberOnly"]`).should('not.be.checked');
      cy.get(`[data-cy="paidMemberOnly"]`).click().should('be.checked');

      cy.get(`[data-cy="publishThirdPartyApp"]`).should('not.be.checked');
      cy.get(`[data-cy="publishThirdPartyApp"]`).click().should('be.checked');
